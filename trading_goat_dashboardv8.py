...
tab_analysis, tab_volume, tab_sector, tab_discovery, tab_watchlist, tab_news, tab_portfolio, tab_metals, tab_ml, tab_alerts, tab_settings = st.tabs([
    "📊 Analysis", "🐋 Volume/Whales", "🗺️ Sector Map", "💎 Discovery", "🎯 Watchlist", "📰 News", "💼 Portfolio", "🥇 Metals", "🤖 ML Lab", "🔔 Alerts", "⚙️ Settings"
])
