...
st.caption("VWAP · RSI · MACD · OBV · Whale Flow · Dark-Pool Proxy · Watchlist Scanner · Sector Flow · Risk Panel")
...
# TABS
# =========================================================
tab_overview, tab_price, tab_volume, tab_indicators, tab_watchlist, tab_sector, tab_news, tab_backtest, tab_settings = st.tabs([
    "Overview", "Price Chart", "Whale Flow", "Indicators", "Watchlist Scanner", "Sector Flow", "News", "Backtest/Risk", "API Hooks"
])
